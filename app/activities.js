...
<div class="research-item is-selected">
    ...
    <strong>${this.esc(item.name) || "Unnamed Activity"}</strong>
...
<div class="research-item">
    ...
    <strong>
        ...
        ${this.esc(item.name) || "Unnamed Activity"}

    </strong>

    <p>

        ${this.esc(item.category) || "Uncategorised"} · ${this.esc(item.provider) || "Unknown Provider"}
